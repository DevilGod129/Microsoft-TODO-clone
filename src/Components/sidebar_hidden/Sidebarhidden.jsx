...
import { Star,PlusIcon,SidebarIcon,EllipsisVertical  } from 'lucide-react';
    ...
    <div class="h-screen w-70 bg-[#1D2125] px-3 py-15  flex flex-col justify-between ">
        ...
        <div className=' h-12 w-full flex px-3 text-gray-400'>
          <div className='w-full justify-between items-center gap-3 ' >
            ...
            <SidebarhiddenItem text={'test'} className="items-center justify-center"/>
          </div>
...
const SidebarhiddenItem = ({text}) => {
  return (
    <div class="flex  mb-3 hover:rounded-md p-2 items-center flex-row justify-between gap-2 ">
